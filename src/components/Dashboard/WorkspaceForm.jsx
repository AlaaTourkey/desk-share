...
function WorkspaceForm() {
  return (
    <div className='p-4'>
        ...
        <form className='p-5 fs-5'>
            <div className='mb-3'>
                <label htmlFor="name" className="form-label p-2">workspace name</label>
                <input type="text" name='name' id='name' className="form-control p-2 py-4 fs-5 border-2 border-info-subtle" placeholder='workspace name' />
            </div>
            <div className="row mb-3">
                <div className="col">
                    <label htmlFor="country" className="form-label p-2">country</label>
                    <select id="country" name="country" className="form-select p-2 py-3 fs-5 border-2 border-info-subtle">
                        <option value="Egypt" selected>Egypt</option>
                    </select>
                </div>
                <div className="col">
                <label htmlFor="city" className="form-label p-2">city</label>
                    <select id="city" name="city" className="form-select p-2 py-3 fs-5 border-2 border-info-subtle">
            ...
            <div className='mb-5'>
                ...
                <input type="text" name='address' id='address' className="form-control p-2 py-4 fs-5 border-2 border-info-subtle" placeholder='workspace address' />
            </div>
